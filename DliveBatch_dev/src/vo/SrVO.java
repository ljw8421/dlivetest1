...
public class SrVO {
	...
	public void setAssigneePersonName(String assigneePersonName) {
		AssigneePersonName = assigneePersonName;
	}
	...
	public String getStatusF_c() {
		return StatusF_c;
	}
	public void setStatusF_c(String statusF_c) {
		StatusF_c = statusF_c;
	}
	...
	public void setCompetitorETC_c(String competitorETC_c) {
		CompetitorETC_c = competitorETC_c;
	}
	...
	public void setDliveCloseDt_c(String dliveCloseDt_c) {
		DliveCloseDt_c = dliveCloseDt_c;
	}
	public String getApprovalYN_c() {
		return ApprovalYN_c;
	}
	public void setApprovalYN_c(String approvalYN_c) {
		ApprovalYN_c = approvalYN_c;
	}
	public String getSRBranch_c() {
		return SRBranch_c;
	}
	public void setSRBranch_c(String sRBranch_c) {
		SRBranch_c = sRBranch_c;
	}
	public String getProblemResult_c() {
		return ProblemResult_c;
	}
